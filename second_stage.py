...
convex = MeshBody(convex_edge_data, convex_edge_cells_dict)
convex.color = 'black'
mesh2 = MeshBody(mesh2_data, mesh2_cells_dict, velocity=np.float64([0, 0, -0.499]))
mesh2.color = 'navy'
glob_mesh = GlobalMesh(convex, mesh2, bs=0.499, master_patches=None)
